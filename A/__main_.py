...
async def restart_notification():
    ...
    if await aiopath.isfile(".update_notify"):
        await sendFile(chat_id, ".update_notify")
        await aioremove(".update_notify")
    if 'Scheduled' not in now.strftime("%A") and restart_notification in bot.get_me().statuses:
